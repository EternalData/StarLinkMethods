...
int main(int argc, char *argv[ ])
{
        if(argc < 5){
                ...
                fprintf(stdout, "Usage: dd_ovh_wl <target IP> <port> <packet_size (use something higher than 501, 100 works sometimes> <number threads to use> <pps limiter, -1 for no limit> <time> \n");
                exit(-1);
        }
